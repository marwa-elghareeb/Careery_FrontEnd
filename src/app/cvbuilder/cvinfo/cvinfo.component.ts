...
export class CvinfoComponent implements OnInit {
  ...
  @ViewChild('alertPopup', { static: true }) alertPopup;// for alert popup
  userData: any = {};
  ...
  // sliderArray
  sliderArr = [
    {src: "assets/images/cv4.1.png", cvType: 'مجانى'},
    {src: "assets/images/CV Images Test/1-100.jpg", cvType: 'مدفوع'},

    {src: "assets/images/CV Images Test/2-100.jpg", cvType: 'مجانى'},
    {src: "assets/images/CV Images Test/3-100.jpg", cvType: 'مدفوع'},

    {src: "assets/images/CV Images Test/4-100.jpg", cvType: 'مجانى'},
    {src: "assets/images/cv4.1.png", cvType: 'مدفوع'},

  ]
  ngOnInit() {
    // $(document).ready(function() {
    if(this.imgSrc == '') {
      this.imgSrc = 'assets/images/cv4.1.png'
    }
