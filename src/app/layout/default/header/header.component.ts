...
export class HeaderComponent implements OnInit {
  @ViewChild('termsconditionModal', {static: true}) termsconditionModal; // for terms agree modal reference
  @ViewChild('askForSignUpModal', {static: true}) askForSignUpModal;// for ask sign up  modal reference
  ...
  forgotPasswordFormSubmitStatus: boolean = false;
  ...
  previousDay: any = new Date(new Date().setFullYear(new Date().getFullYear()-15)); // get date
  nextDay: any = new Date(1980,0,1); 
  ...
  */
  ...
  createSignUpForm() {
    this.registerForm = this.fb.group({
      ...
      email: [''],
      mobile_code: [''],
      mobile_no: ['',[Validators.minLength(10), Validators.maxLength(10)]],
      password: ['', [Validators.required,  this.noWhitespaceValidator, Validators.pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&].{8,}')]],
      confirmpassword: ['', [Validators.required,  this.noWhitespaceValidator, Validators.pattern('(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&].{8,}')]],
  ...
  forgotPasswordAction() {
    ...
    this.forgotPasswordFormSubmitStatus = true;
    console.log(this.forgotPasswordForm.valid);
    if( this.forgotPasswordForm.valid) {
      this.forgotPasswordFormSubmitStatus = false;
  ...
  setRegisterBy(type) {
    ...
    if (type == 'email') {
      ...
      this.registerForm.controls['mobile_no'].setValidators([Validators.required, Validators.minLength(10), Validators.maxLength(10), Validators.pattern('^[1-9]+$')]);
