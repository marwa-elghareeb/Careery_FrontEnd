...
import { CareeryBoxComponent } from './careery-box/careery-box.component';
...
@NgModule({
  declarations: [ GenderNamePipe, PaginationComponent, BlocksmodalComponent,SanitizeHtmlPipe, PicturepathPipe, ChatComponent, OnlynumaricinputDirective, CareeryBoxComponent],
  imports: [
    MomentModule,
    DateFormatModule,
    NgSelectModule,
