...
import { CardbuilderComponent } from '../Careery/cardbuilder/cardbuilder.component';
...
import { CardbuildersuccessComponent } from '../Careery/cardbuildersuccess/cardbuildersuccess.component';
...
import { MatTabLabel } from '../../../node_modules/@angular/material/tabs';
...
@NgModule({
  declarations: [// ProfileviewComponent,
    ProfileeditComponent, ListComponent, PrivacysettingsComponent, PublicprofileComponent, TestimonialComponent, ControllpanelsettingsComponent, CardbuilderComponent, ChangepasswordComponent,  ConnectionsComponent, BlocksComponent, NotificationsComponent, SeemorenotificationsComponent, AllInvitationsComponent, AllRecommendationsComponent, CardbuildersuccessComponent, NotificationsettingsComponent, ChatHistoryComponent, PreviewcvComponent, LifetimeComponent, MyblocklistComponent],
  imports: [
    ImageCropperModule,
    CommonModule,
