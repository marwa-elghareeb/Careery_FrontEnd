...
export class ProfileviewComponent implements OnInit {
  ...
  @ViewChild('cardOwl', { static: true }) cardOwl: OwlCarousel;
  @ViewChild('pointsModal', { static: true }) pointsModal; // point modal reference
  @ViewChild('careeryPathModal', { static: true }) careeryPathModal; // careery path reference
  @ViewChild('careeryMyVideoModal', { static: true }) careeryMyVideoModal; // careery path reference
  ...
  slides = [
    {title: "انشاء سيرتك الذاتية", info: "لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل ليتصور طريقه", cardIcon:"far fa-id-badge"},
    {title: "انشاء الذاتية", info: "لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل ليتصور طريقه", cardIcon:"far fa-id-card"},
    {title: " سيرتك الذاتية", info: "لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل ليتصور طريقه", cardIcon:"far fa-comments"},
    {title: "انشاء سيرتك ", info: "لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل ليتصور طريقه", cardIcon:"far fa-id-card"},
  ];
 ...
 */
  fileChangeListener($event, cropper) {
    ...
    if (file && (file.type == 'image/jpeg' || file.type == 'image/png' || file.type == 'image/gif')) {
      // console.log(file);6090076
      if (file.size <= 3145728) { // check image size < 3mb
