...
export class CardbuilderComponent implements OnInit {
  ...
  @ViewChild('paymentModal', { static: true }) paymentModal;// for payment popup
...
*/
  ...
  */
  ...
  // sliderArray
  sliderArr = [
    {src: "assets/images/CV Images Test/BC - 1.jpg", cvType: 'مجانى'},
    {src: "assets/images/CV Images Test/BC -2-100.jpg", cvType: 'مدفوع'},
    {src: "assets/images/CV Images Test/BC -3-100.jpg", cvType: 'مجانى'},
  ]
  ngOnInit() {
    if(this.imgSrc == '') {
      this.imgSrc = 'assets/images/CV Images Test/BC - 1.jpg'
    }
