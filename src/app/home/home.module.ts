...
import { SignupthankyouComponent } from '../Auth/signupthankyou/signupthankyou.component';
import { SignupverificationComponent } from '../Auth/signupverification/signupverification.component';
...
@NgModule({
  declarations: [LandingComponent,
    ...
    //  SignupverificationComponent,
      ...
      UserlevelComponent, SetupprofileComponent,
    //  CmspageComponent
    ],
  imports: [
    CommonModule,
